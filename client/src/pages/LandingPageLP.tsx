/**
 * MAMA-HAFEN LANDINGPAGE /lp – Variante mit Bild statt Video im Hero
 * Identisch mit Home.tsx, aber:
 * - Hero: Bild (mama-hafen-hero.webp) statt Video
 * - Video: nach der Über-Darleen-Sektion eingebettet
 */
...
const IMG_HERO = "/manus-storage/mama-hafen-hero_b7256872.webp";
        ...
        <div className="container" style={{ maxWidth: 720 }}>
          <FadeUp>
            <h2 style={{
              ...
              Darleen erklärt dir, wie der Kurs dein Mamaleben verändert
            </h2>
            <p style={{ textAlign: "center", color: "var(--muted-foreground)", marginBottom: "2rem", fontSize: "0.9rem" }}>
              Schau dir das kurze Video an – und entscheide dann selbst.
            </p>
          </FadeUp>
          <FadeUp delay={80}>
            <div style={{
